...
/***************************************************************************//**
 * @brief
 *	Callback for SI7021 Read events from i2c communication
 *
 * @details
 *	This function handles the SI7021 Read event and toggles LED1 based on the temperature reading from the
